...
import { ArrowLeft, ShieldAlert, Lock, SearchX } from "lucide-react";
        ...
        <main className="mx-auto w-full max-w-7xl px-6 py-24 sm:py-32 lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:px-8">
          ...
          >
            ...
            <p className="mt-6 text-pretty text-sm font-medium text-lime-300/70 sm:text-lg">
              Looks like you've wandered into a dark corner of the Goblin Realm
              that doesn't exist{" "}
              <motion.span
                animate={{
                  y: [0, -5, 0],
              ...
              . There's nothing here but cobwebs and confused toads. Try heading
              back before a troll finds you{" "}
              <motion.span
          ...
          >
            ...
            >
              <div className="w-16 h-16 bg-lime-500/20 backdrop-blur-md rounded-full flex items-center justify-center">
                <SearchX className="h-8 w-8 text-lime-400" />
              </div>
            </motion.div>
